<?php
/**
 * hosteria functions and definitions.
 *
...
function hosteria_setup() {
	 ...
	 * If you're building a theme based on hosteria, use a find and replace
	 * to change 'hosteria' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'hosteria', get_template_directory() . '/languages' );
	...
	add_theme_support( 'custom-background', apply_filters( 'hosteria_custom_background_args', array(
...
function hosteria_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'hosteria' ),
		'id'            => 'sidebar-1',
		'description'   => '',
